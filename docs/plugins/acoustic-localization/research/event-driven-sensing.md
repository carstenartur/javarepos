...
- the microphone array needs a shared sample clock; a calibrated virtual time
  base (e.g. an ultrasonic reference beacon, see
  ...
  is an experimental/future approach and is **not** provided by the current codebase;
