...
public record Room2D(
    double widthMeters, double heightMeters, double reflectionGain, double noiseAmplitude) {

  /** Create room parameters. */
  public Room2D {
    if (!(widthMeters > 0.0)
        || !(heightMeters > 0.0)
        || !Double.isFinite(widthMeters)
