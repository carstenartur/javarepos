 ...
 * the originating {@link org.hammer.audio.core.AudioBlock}, and any per-analyzer metadata. They
 * are detached from realtime mutable state and safe to serialize for export, transport over an
 * API, or render in any UI toolkit.
 *
