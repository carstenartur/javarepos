 ...
 * float[channels][frames]} sample arrays — the canonical platform representation. The legacy
 * {@link org.hammer.audio.AudioCaptureServiceImpl} uses this decoder to produce {@link
